...
import { submitAssignment } from "../functions/api/assignmentAPI";
...
function AddAssignment(props) {
    ...
    const addNewAssignment = async (e) => {
      e.preventDefault();
       ...
       var defaultImageURL = (random === 1 ? ("https://marketplace.canva.com/EAD2962NKnQ/2/0/1600w/canva-rainbow-gradient-pink-and-purple-zoom-virtual-background-_Tcjok-d9b4.jpg"):
                              random === 2 ? ("https://images.ctfassets.net/hrltx12pl8hq/5KiKmVEsCQPMNrbOE6w0Ot/341c573752bf35cb969e21fcd279d3f9/hero-img_copy.jpg?fit=fill&w=800&h=300"):
                              random === 3 ? ("https://img.freepik.com/free-vector/hand-painted-watercolor-pastel-sky-background_23-2148902771.jpg"):
       ...
       var moduleId = props.moduleId
        ...
        const formData ={
          ...
          "endDate":dueTimestamp,
          "numOfReviewers":numOfPeers,
          "imageURL":defaultImageURL,
          "students":students,
          "teachers":teachers,
        }
        
        //USE THE FETCH BELOW: REPLACE SUBMIT ASSIGNMENT WITH THE NEW API FUNCTION FOR ADDING ASSIGNMENT
       // const response = await submitAssignment(formData, ReactSession.get("token")); // get user details
    ...
    {//formats the the time so it is able to be read by Date
       ...
       // console.log(tempHour + " " + tempMin + " " + tempMeridiem);
        ...
        switch(month){case "Jan": monthVal="01"; break; 
        ...
        return monthVal+ "/" + tempDate.split(" ")[2] + "/" + tempDate.split(" ")[3] + " " + tempHour + ":" + tempMin + ":00" 
    }
