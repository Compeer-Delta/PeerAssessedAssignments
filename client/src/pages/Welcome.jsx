...
<img src={sideImage} className =" mb-11 object-fill z-10 font-Dosis sidebar text-slate-200 dark:text-slate-100 lg:left-0 w-[0px] sm:w-[0px] 2xl:w-[1003px] xl:w-[0px] 2xl:h-full text-left bg-slate-900 dark:bg-indigo-900"/>{/* bars icon */}
      ...
      <div className= 'h-screen 2xl:pr-80 font-Dosis dark:bg-zinc-900 bg-white w-full '>
        ...
        <div className='z-20 sm:pl-10 ml-10 2xl:w-3/4 h-full dark:bg-zinc-900 bg-white 2xl:h-1/2 sm:h-full mb-64 pb-10 '>
          ...
          <h1 className= 'py-20 text-4xl sm:text-7xl w-full text-slate-600 font-semibold dark:text-white rounded-md'> Welcome to COMPEER!</h1> 

           {/* login by google account (not yet implemented) */}
          <Link to="/google-login" className="btn btn-primary rounded-full px-70 py-3 mb-4 h-8 w-80 text-white dark:text-[#4285F4] bg-[#4285F4] dark:bg-white hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium text-sm px-5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2">
          ...
          <Link to="/apple-login" className="btn btn-primary rounded-full px-70 py-3 mb-4 h-8 w-80 text-white bg-[#050708] dark:bg-white dark:text-[#050708] hover:bg-[#050708]/90 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium text-sm px-5 text-center inline-flex items-center dark:focus:ring-[#A8ADAC]/50  mr-2">
