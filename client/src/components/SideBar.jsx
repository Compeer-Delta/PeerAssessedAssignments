        ...
        <>
                    ...
                    {sidebardata.map((item, index) =>{
                        return (
                            ...
                            ((item.path === "viewfeedback" && outputData.accountType === "teacherAccount")) ? (<></>):(
                    ...
                    {/* Teachers tab */}
                    <h1 className = 'dark:border-indigo-900 mt-32 rounded-bl-lg rounded-tl-lg border-solid border-2 border-zinc-600 font-semibold sidebar fixed lg:right-0 p-5 w-[300px] overflow-y-auto text-center text-gray-900 dark:text-gray-300 bg-slate-300 dark:bg-zinc-800'> Module Teachers
