    ...
    >
      ...
      <div className=" flex flex-row-2">
        {prevUrl.includes("/viewsubmissions") == true ? (
          ...
          <Link
            to={prevUrl}
            className=" rounded-lg font-Dosis text-slate-900 dark:text-slate-100 dark:bg-zinc-700 bg-slate-400 text-center w-[150px] py-4 ml-1  text-m md:text-l font-semibold hover:bg-slate-300 dark:hover:bg-indigo-900"
          >
            {" "}
            Back to {prevPageName}
          </Link>
      ...
      <h1 className="text-center mr-44 w-full text-2xl  md:text-4xl mb-1 md:mb-4 font-semibold  text-gray-300 rounded-md">
        {" "}
        COMPEER
      </h1>
    </div>
